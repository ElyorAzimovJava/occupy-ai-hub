...
function AnalyticsPage() {
  return (
    <div>
      <PageHeader title="Analytics" subtitle="Occupancy, revenue, bookings and peak hours across the platform."
